...
{
    public class ShippingBillEntryModifyViewModel : NotificationObject, IValidationExceptionHandler
    {
        ...
        {
            if (!this.IsValid || ShippingBillEntry.Quantity <= 0|| ShippingBillEntry.GoodsType<=0 || ShippingBillEntry.EntryId<=0)
            {
